...
import com.pmovil.jsonapi.StringWriter;
...
public class JSONValue {
	...
	public static Object parse(String s){
            try {
		return parse(new InputStreamReader(new ByteArrayInputStream(s.getBytes("UTF8")), "UTF8"));
	...
	public static Object parseWithException(String s) throws IOException{
		JSONParser parser=new JSONParser();
		return parser.parse(new InputStreamReader(new ByteArrayInputStream(s.getBytes("UTF8")), "UTF8"));
	}
